...
import { Boxes, PlayCircle, Layers3, Server } from 'lucide-react'
...
const stats = [
  { label: 'Clusters', icon: Boxes, color: 'from-violet-500/20 to-violet-600/10', iconColor: 'text-violet-600' },
  { label: 'Running Tasks', icon: PlayCircle, color: 'from-emerald-500/20 to-emerald-600/10', iconColor: 'text-emerald-600' },
  { label: 'Active Services', icon: Layers3, color: 'from-sky-500/20 to-sky-600/10', iconColor: 'text-sky-600' },
  { label: 'Container Instances', icon: Server, color: 'from-amber-500/20 to-amber-600/10', iconColor: 'text-amber-600' },
]

export function EcsStats({ clusterCount, runningTaskCount, activeServiceCount, containerInstanceCount }) {
  const values = [clusterCount, runningTaskCount, activeServiceCount, containerInstanceCount]
