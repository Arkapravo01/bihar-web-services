...
import { Database, Briefcase, Bug } from 'lucide-react'
...
const stats = [
  { label: 'Databases',  icon: Database, color: 'from-sky-500/20 to-sky-600/10',        iconColor: 'text-sky-600' },
  { label: 'Workflows',  icon: Briefcase, color: 'from-violet-500/20 to-violet-600/10', iconColor: 'text-violet-600' },
  { label: 'Crawlers',   icon: Bug,       color: 'from-emerald-500/20 to-emerald-600/10', iconColor: 'text-emerald-600' },
]

export function GlueStats({ dbCount, jobCount, crawlerCount }) {
  const values = [dbCount, jobCount, crawlerCount]
