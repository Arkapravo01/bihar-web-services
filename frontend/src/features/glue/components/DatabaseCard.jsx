    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="font-medium text-slate-900 dark:text-slate-50 truncate">{database.name}</h3>
          {database.description && (
            <p className="text-xs text-slate-600 dark:text-slate-400 mt-1 line-clamp-2">{database.description}</p>
          )}
