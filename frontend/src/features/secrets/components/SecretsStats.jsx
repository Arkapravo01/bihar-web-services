...
const stats = [
  { label: 'Secrets', icon: KeyRound, color: 'from-violet-500/20 to-violet-600/10', iconColor: 'text-violet-600' },
  { label: 'Rotating', icon: RefreshCw, color: 'from-emerald-500/20 to-emerald-600/10', iconColor: 'text-emerald-600' },
  { label: 'Not rotating', icon: ShieldOff, color: 'from-amber-500/20 to-amber-600/10', iconColor: 'text-amber-600' },
]

export function SecretsStats({ totalCount, rotatingCount, notRotatingCount }) {
  const values = [totalCount, rotatingCount, notRotatingCount]
